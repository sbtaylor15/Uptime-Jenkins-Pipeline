...
@Library('deployhub') _
 ...
 node {
    ...
    stage ('Testing') {
      ...
      echo "${version}";
      def component_items = [
          [name:'f_index',repo: 'GLOBAL.American University.CSC589.chili.JenkinsRepo', uri: 'http://google.com', pattern: 'index.html'],
          [name:'f_readme',repo: 'GLOBAL.American University.CSC589.chili.JenkinsRepo', uri: 'http://read.google.com', pattern: 'read.me'],
          [name:'f_help',repo: 'GLOBAL.American University.CSC589.chili.JenkinsRepo', uri: 'http://help.google.com', pattern: 'help.asp'],
      ];
